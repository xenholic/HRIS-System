...
router.post("/employees/upload", upload.array('files'), EmployeeController.multipleFileUpload);
router.post("/employees/add-employee", EmployeeController.addNewEmployees);
